...
// ---- Alcohol Participant ----
export async function upsertAlcoholParticipant(villageId: number, year: number, data: {
  targetCount: number
  participantCount: number
  quitCount: number
  reducedCount: number
}) {
  await prisma.alcoholParticipant.upsert({
    where: { villageId_year: { villageId, year } },
    create: { villageId, year, ...data },
    update: data,
  })
...
// ---- Alcohol Result ----
export async function upsertAlcoholResult(villageId: number, year: number, data: {
  month3Quit: number
  month3Reduced: number
  month6Quit: number
  month6Reduced: number
}) {
  await prisma.alcoholResult.upsert({
    where: { villageId_year: { villageId, year } },
    create: { villageId, year, ...data },
    update: data,
  })
...
// ---- Tobacco Participant ----
export async function upsertTobaccoParticipant(villageId: number, year: number, data: {
  targetCount: number
  participantCount: number
  quitCount: number
  reducedCount: number
}) {
  await prisma.tobaccoParticipant.upsert({
    where: { villageId_year: { villageId, year } },
    create: { villageId, year, ...data },
    update: data,
  })
...
// ---- Tobacco Result ----
export async function upsertTobaccoResult(villageId: number, year: number, data: {
  month3Quit: number
  month3Reduced: number
  month6Quit: number
  month6Reduced: number
}) {
  await prisma.tobaccoResult.upsert({
    where: { villageId_year: { villageId, year } },
    create: { villageId, year, ...data },
    update: data,
  })
...
// ---- Drink Not Drive ----
export async function upsertDrinkNotDrive(villageId: number, year: number, data: {
  pledgeCount: number
  checkpointCount: number
  violationCount: number
}) {
  await prisma.drinkNotDrive.upsert({
    where: { villageId_year: { villageId, year } },
    create: { villageId, year, ...data },
    update: data,
  })
...
export async function upsertCommunityStats(villageId: number, year: number, data: {
  meetingCount: number
  participantCount: number
  fundAmount: number
