...
type Member = {
  id?: number; name: string; drinkType: string
...
export type AlcoholMembersTableHandle = { save: () => Promise<void> }

const AlcoholMembersTable = forwardRef<AlcoholMembersTableHandle, { villageId: number; initial: Member[] }>(
  function AlcoholMembersTable({ villageId, initial }, ref) {
    ...
    useImperativeHandle(ref, () => ({
      async save() {
        ...
        await saveAlcoholMembers(villageId, payload)
      }
    }), [villageId, members])
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left px-4 py-2.5 font-medium text-gray-400 min-w-[110px]">ประเภทการดื่ม</th>
...
export default AlcoholMembersTable
